...
import time
LICNECE = """
Nitro generator include in the Well Multi-Tools

Nitro generator by Well_Dekur if you have problem add "wdekur" on discord
"""
    ...
    def main(self):  # The main function contains the most important code
        ...
        if os.name == "nt":  # If the system is windows
            ...
            ctypes.windll.kernel32.SetConsoleTitleW(
                "Nitro Generator and Checker - Made by wdekur")
        ...
        self.slowType("Made by: wdekur", .02)
