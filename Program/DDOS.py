...
def main():
    ...
    if platform.system() == 'Windows':
        ctypes.windll.kernel32.SetConsoleTitleW("Well Multi Tools|Ddos Attacker")
...
░░▒████▓ ░░▒████▓ ░ ████▓▒░▒██████▒▒     ▓█   ▓██  ▒██▒ ░   ▒██▒ ░  ▓█   ▓██▒ ▓███▀  ▒██▒ █▄░▒████░██▓ ▒██▒
 ░ ▒▒▓  ▒ ░ ▒▒▓  ▒ ░ ▒░▒░▒░ ▒ ▒▓▒ ▒ ░     ▒▒   ▓▒█  ▒ ░░     ▒ ░░    ▒▒   ▓▒█░ ░▒ ▒   ▒ ▒▒ ▓▒░░ ▒░ ░ ▒▓ ░▒▓░
   ...
   ░ ░  ░   ░ ░  ░ ░ ░ ░ ▒  ░  ░  ░        ░   ▒    ░ ░      ░ ░      ░   ▒  ░        ░ ░░ ░  ░     ░   ░ 
    ...
    port = input(f'''{Fore.BLUE}[{Fore.WHITE}+{Fore.BLUE}] {Fore.WHITE}Enter port (Enter for Default): ''')
    force = input(f'''{Fore.BLUE}[{Fore.WHITE}+{Fore.BLUE}] {Fore.WHITE}Bytes per packet (Or Enter For Default): ''')
    threads = input(f'''{Fore.BLUE}[{Fore.WHITE}+{Fore.BLUE}] {Fore.WHITE}Threads (Enter For Default): ''')
    ...
    print(Fore.GREEN +f'''
> {Fore.WHITE}Starting attack on {Fore.BLUE}[{Fore.WHITE}{ip}{Fore.BLUE}].''')
    ...
    try:
        while True:
            user_input = input(f'''{Fore.BLUE}[{Fore.WHITE}00{Fore.BLUE}] {Fore.WHITE}Exit

{Fore.GREEN}[{Fore.WHITE}>{Fore.BLUE}]{Fore.WHITE} ''')
